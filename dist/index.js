...
/* harmony import */ var _wait__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(653);
/* harmony import */ var _wait__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__nccwpck_require__.n(_wait__WEBPACK_IMPORTED_MODULE_1__);
...
async function run() {
  try {
    const ms = (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('milliseconds');
    (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.info)(`Waiting ${ms} milliseconds ...`);

    (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.debug)((new Date()).toTimeString()); // debug is only output if you set the secret `ACTIONS_RUNNER_DEBUG` to true
    await _wait__WEBPACK_IMPORTED_MODULE_1___default()(parseInt(ms));
    (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.info)((new Date()).toTimeString());

    (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.setOutput)('time', new Date().toTimeString());
  } catch (error) {
